 ...
 *
 * Task-domain API surface: tasks, diffs, inline comments, agents/terminals,
 * workflow updates, worktrees, chats, plus the repo-browse / branch / preflight
 * helpers used by the task-create flow. Mirrors the per-domain routers under
 * `server/routes/` (tasks, diffs, comments, task-agents, task-workflow,
 * worktrees, chats, misc).
 */
