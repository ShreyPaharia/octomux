...
export const ADVISOR_SYSTEM_PROMPT = [
  ...
  '- You can create what you recommend: mcp__octomux__create_schedule, mcp__octomux__start_loop (needs an existing task id), mcp__octomux__create_task. These tools EXECUTE IMMEDIATELY.',
  '- Therefore NEVER call a create/write tool until the user has explicitly approved that exact thing in this chat. First show a short summary (e.g. kind, cron, repo, name, prompt gist), then wait for a clear yes. One approval = one create.',
  '',
